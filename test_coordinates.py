...
def test_Met():
    assert (Met(0,0,0,0,0) == np.eye(4)).all()
    assert all_rots(lambda i: Met(0, 0, 0, i, 0))
    assert all_rots(lambda i: Met(0, 0, 0, 0, i))
    assert eq(Met(4,9,25,0,0) * v(4,9,25), v(0,0,0))
    assert eq(Met(4,9,25,90,0) * v(4+1,9,25), v(1,0,0))
    assert eq(Met(4,9,25,90,0) * v(4,9+1,25), v(0,0,-1))
    assert eq(Met(4,9,25,90,0) * v(4,9,25+1), v(0,1,0))
    assert eq(Met(4,9,25,0,90) * v(4+1,9,25), v(0,0,1))
    assert eq(Met(4,9,25,0,90) * v(4,9+1,25), v(0,1,0))
    assert eq(Met(4,9,25,0,90) * v(4,9,25+1), v(-1,0,0))
    assert eq(Met(4,9,25,90,90) * v(4+1,9,25), v(0,0,1))
    assert eq(Met(4,9,25,90,90) * v(4,9+1,25), v(1,0,0))
    assert eq(Met(4,9,25,90,90) * v(4,9,25+1), v(0,1,0))
...
def test_Mtp():
    ...
    assert eq(Mtp(41,13,95,90,0,0) * v(41+1, 13, 95), v(1,0,0))
    ...
    assert eq(Mtp(41,13,95,0,90,0) * v(41, 13+1, 95), v(0,1,0))
    ...
    assert eq(Mtp(41,13,95,0,0,90) * v(41, 13, 95+1), v(0,0,1))
    assert eq(Mtp(41,13,95,90,90,0) * v(41+1, 13, 95), v(0,0,1))
    assert eq(Mtp(41,13,95,90,90,0) * v(41, 13+1, 95), v(1,0,0))
    assert eq(Mtp(41,13,95,90,90,0) * v(41, 13, 95+1), v(0,1,0))
    assert eq(Mtp(41,13,95,90,0,90) * v(41+1, 13, 95), v(0,-1,0))
    assert eq(Mtp(41,13,95,90,0,90) * v(41, 13+1, 95), v(0,0,-1))
    assert eq(Mtp(41,13,95,90,0,90) * v(41, 13, 95+1), v(1,0,0))
    assert eq(Mtp(41,13,95,90,90,90) * v(41+1, 13, 95), v(0,0,1))
    assert eq(Mtp(41,13,95,90,90,90) * v(41, 13+1, 95), v(0,-1,0))
    assert eq(Mtp(41,13,95,90,90,90) * v(41, 13, 95+1), v(1,0,0))
